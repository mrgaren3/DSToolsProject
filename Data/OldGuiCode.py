...
class BookStoreApp:
    def __init__(self, root):
        ...
        self.visualizations_tab = ttk.Frame(self.tab_control)
        self.tab_control.add(self.visualizations_tab, text="Visualizations")
    ...
    def setup_add_book_tab(self):
        # Title Labels
        tk.Label(self.add_book_tab, text="Title", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=0, column=0, padx=15, pady=10, sticky="e")
        tk.Label(self.add_book_tab, text="Author", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=1, column=0, padx=15, pady=10, sticky="e")
        tk.Label(self.add_book_tab, text="Price", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=2, column=0, padx=15, pady=10, sticky="e")
        tk.Label(self.add_book_tab, text="Quantity", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=3, column=0, padx=15, pady=10, sticky="e")
        tk.Label(self.add_book_tab, text="Type", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=4, column=0, padx=15, pady=10, sticky="e")
        tk.Label(self.add_book_tab, text="Purchase Date", font=("Times New Roman", 14, "bold"),
                 bg="#ecf0f1").grid(row=5, column=0, padx=15, pady=10, sticky="e")

        # Entry Widgets
        self.title_entry = tk.Entry(self.add_book_tab, font=("Tahoma", 12))
        self.title_entry.grid(row=0, column=1, padx=15, pady=10)

        self.author_entry = tk.Entry(self.add_book_tab, font=("Tahoma", 12))
        self.author_entry.grid(row=1, column=1, padx=15, pady=10)

        self.price_entry = tk.Entry(self.add_book_tab, font=("Tahoma", 12))
        self.price_entry.grid(row=2, column=1, padx=15, pady=10)

        self.quantity_entry = tk.Entry(self.add_book_tab, font=("Tahoma", 12))
        self.quantity_entry.grid(row=3, column=1, padx=15, pady=10)

        self.type_entry = tk.Entry(self.add_book_tab, font=("Tahoma", 12))
        self.type_entry.grid(row=4, column=1, padx=15, pady=10)

        # DateEntry widget for Purchase Date
        self.date_entry = DateEntry(self.add_book_tab, date_pattern='y-mm-dd', font=("Tahoma", 12))
    ...
    def setup_sell_book_tab(self):
        tk.Label(self.sell_book_tab, text="Book ID",
                 font=("Times New Roman", 14, "bold")).grid(row=0, column=0, padx=15, pady=10)
        tk.Label(self.sell_book_tab, text="Quantity",
    ...
    def setup_analysis_tab(self):
        self.analysis_btn = tk.Button(self.analysis_tab, text="Analyze Books", command=on_analyze_books,
                                      font=("Times New Roman", 13, "bold"),
                                      activebackground="blue", activeforeground="white",
                                      highlightthickness=0)
        self.analysis_btn.pack(pady=20)

        self.recommend_btn = tk.Button(self.analysis_tab, text="Recommend Book", command=on_recommend_book,
                                       font=("Times New Roman", 13, "bold"),
                                       activebackground="blue", activeforeground="white",
                                       highlightthickness=0)
    ...
    def setup_show_data_tab(self):
        ...
        tk.Label(search_frame, text="Search By:", font=(
            "Times New Roman", 12, "bold")).pack(side="left", padx=5)
    ...
    def setup_visualizations_tab(self):
        tk.Label(self.visualizations_tab, text="Choose a Visualization", font=("Times New Roman", 16, "bold")).pack(pady=10)

        tk.Button(self.visualizations_tab, text="Rating Distribution", command=show_rating_distribution,
                  font=("Times New Roman", 13, "bold"),
                  activebackground="blue", activeforeground="white", highlightthickness=0).pack(pady=5)
        tk.Button(self.visualizations_tab, text="Top Authors", command=show_top_authors,
                  font=("Times New Roman", 13, "bold"),
                  activebackground="blue", activeforeground="white", highlightthickness=0).pack(pady=5)
        tk.Button(self.visualizations_tab, text="Genre Count", command=show_genre_count,
                  font=("Times New Roman", 13, "bold"),
                  activebackground="blue", activeforeground="white", highlightthickness=0).pack(pady=5)
        tk.Button(self.visualizations_tab, text="Price Distribution", command=show_price_distribution,
                  font=("Times New Roman", 13, "bold"),
                  activebackground="blue", activeforeground="white", highlightthickness=0).pack(pady=5)
